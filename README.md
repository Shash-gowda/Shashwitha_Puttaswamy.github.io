...
Analysis (SC18) held in Dallas, TX from November 12-15, 2018.</li>
      <li><strong>HTCondor Week 2018 ,University of Wisconsin–Madison, Fluno Center: </strong> Participated in the annual HTCondor Week, engaging with developers, administrators, and users to explore advancements in high-throughput computing. Attended tutorials and presentations on topics such as DAGMan workflows, Python bindings, and HTCondor administration. https://agenda.hep.wisc.edu/event/1201/timetable/?view=standard_numbered Contributed to discussions on integrating HTCondor with cloud platforms, containerization technologies like Docker and Singularity, and optimizing job scheduling for scientific applications. Collaborated with peers from academia and industry to exchange best practices and enhance computational workflows.</li>
      <li><strong>CMS(Compact Muon Solenoid) Tier-2 Center Site:</strong> I gave a presentation at the University of Utah on the Caltech Tier-2 site and its current status. The Caltech Tier-2 facility is an integral part of the global infrastructure supporting LHC data processing.I have contributed to the CMS experiment at the LHC (Large Hadron Collider) by supporting Caltech’s Tier-2 computing and storage facility.</li>
